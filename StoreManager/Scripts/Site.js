...
storeManager.initValidator = function () {
...
storeManager.initAutosizer = function () {
    $('textarea').autosize({ append: "\n" }); // Source: http://www.jacklmoore.com/autosize
};

storeManager.initDatePicker = function () {
...
$(function () {
    storeManager.initValidator();
    storeManager.initAutosizer();
    storeManager.initDatePicker();
